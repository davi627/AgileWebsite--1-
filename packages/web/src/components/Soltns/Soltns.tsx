    ...
    const fetchSolutionCategories = async () => {
      try {
        const API_BASE_URL =
          ...
          'https://webtest-api.agilebiz.co.ke:5000'
        ...
        setError(
          error instanceof Error ? error.message : 'Failed to load solutions'
        )
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section
          className={`relative bg-gradient-to-r ${themeColor.gradientFrom} ${themeColor.gradientTo} text-white py-24`}
        >
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              End-to-end technology solutions transforming businesses across
              industries
            </p>
          </div>
        </section>
        ...
        <section className="py-16 container mx-auto px-4">
          {solutionCategories.map(
            (category: SolutionCategory, index: number) => (
              <div key={index} className="mb-20">
                <div className="flex items-center mb-8">
                  <div className={`h-1 w-12 ${themeColor.primary} mr-4`}></div>
                  <h2 className={`text-3xl font-bold ${themeColor.text}`}>
                    {category.title}
                  </h2>
                </div>
                      ...
                      <div className="p-6">
                        ...
                        {expandedSolution === solution.id && (
                          <div className="mb-6 animate-fadeIn">
                            ...
                            <h4
                              className={`font-semibold ${themeColor.text} mb-2`}
                            >
                              Key Features:
                            </h4>
                            <ul className="space-y-2 mb-4">
                              {solution.features.map(
                                (
                                  ...
                                  >
                                    <svg
                                      className={`h-5 w-5 ${themeColor.text} mr-2 mt-0.5`}
                                      fill="none"
                                      viewBox="0 0 24 24"
                                      stroke="currentColor"
                                    >
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-sm rounded-2xl p-8">
              ...
              <p className="text-xl mb-8">
                Our solution architects will design a customized technology
